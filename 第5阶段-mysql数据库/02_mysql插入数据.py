...
sql = "INSERT INTO t_panel_job_file(file_id, file_name, job_id, file_path, storage_status, sync_status, file_date, create_time, modify_time) " \
      "VALUES ('20231113155447403500261', '工商企业查询年报财务数据表(原文件).csv', '20231113155407638500257', '/home/qe/project_cen/pycharm_project_666/OnlineSyn/userdata/20231113155407638500257/工商企业查询年报财务数据表(原文件)/工商企业查询年报财务数据表(原文件).csv', '1', 'S', '2023-11-13', '2023-11-13 15:54:51', '2023-11-13 15:54:55');"
# 执行sql
